#ifndef SI468X_FW_ROM0_MINI_003_H
#define SI468X_FW_ROM0_MINI_003_H
/* Generated from the user-provided Si468x firmware package.
 * This file is independent of Si468x.h and may be used by any project.
 * Define SI468X_FW_STORAGE before including this header when a compiler-
 * specific placement attribute is required (for example PROGMEM on AVR).
 */
#include <stdint.h>
#include <stddef.h>
#ifndef SI468X_FW_STORAGE
#define SI468X_FW_STORAGE
#endif

static const uint32_t si468x_rom0_mini_003_size = 940UL;
static const uint32_t si468x_rom0_mini_003_crc32 = 0x8944B5AEUL;
static const char si468x_rom0_mini_003_version[] = "ROM0.MINI.003";
static const uint8_t si468x_rom0_mini_003[] SI468X_FW_STORAGE = {
...
#endif // SI468X_FW_ROM0_MINI_003_H
